...
const command = new SlashCommand()
  ...
  .setRun(async (client, interaction) => {
    ...
    helpEmbed.addFields({
      name: "Credits",
      value:
        `esc music Bot Version: v${
          require("../../package.json").version
        }; Build: ${gitHash}` +
        "\n" +
        `[Support Server](${client.config.supportServer}) | [Issues](${client.config.Issues}) | [Source](https://discord.gg/Xf85pNbHUv) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
    });
